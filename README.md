...
The radius of curvature is calcuated using `measure_radius_of_curvature()` in code cell 15 and center of offset is calculated using `Center_Offset()` code cell 17.
